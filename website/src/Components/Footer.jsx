  ...
  return (
    ...
    {/* Copyright Text */}
      ...
      <div className="social-icons">
        <a href="https://www.youtube.com/user/IEEEorg" target="_blank" rel="noopener noreferrer">
          <img src="https://img.icons8.com/ios-filled/24/youtube.png" alt="Youtube" />
        </a>
        <a href="https://x.com/IEEEorg" target="_blank" rel="noopener noreferrer">
          <img src="https://img.icons8.com/ios-filled/24/twitter.png" alt="Twitter" />
        </a>
        <a href="https://www.facebook.com/ieeespokane/" target="_blank" rel="noopener noreferrer">
          <img src="https://img.icons8.com/ios-filled/24/facebook.png" alt="Facebook" />
        </a>
        <a href="https://www.linkedin.com/company/ieee" target="_blank" rel="noopener noreferrer">
          <img src="https://img.icons8.com/ios-filled/24/linkedin.png" alt="LinkedIn" />
        </a>
        <a href="https://www.instagram.com/ieeeypspokane/?hl=en" target="_blank" rel="noopener noreferrer">
